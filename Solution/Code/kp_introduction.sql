...
VALUES (NULL, 'Life Is Good', 'https://www.youtube.com/watch?v=l0U7SxXHkPY', 'Pop', 'Trap', 'Duo', 237, 2100050978, 2, 1, 1),
       ...
       (NULL, 'Round Midnight', 'https://www.youtube.com/watch?v=Ys9wiGNDCvA', 'Jazz', 'Bebop', 'Quartet', 375, 110000000, 4, 3, 8),
       ...
       (NULL, 'So What', 'https://www.youtube.com/watch?v=ylXk1LBvIqU', 'Jazz', 'Modal Jazz', 'Quintet', 579, 32000000, 8, 3, 15),
       (NULL, 'Uptown Funk', 'https://www.youtube.com/watch?v=OPf0YbXqDm0', 'Pop', 'Funk', 'Band', 270, 826500009, 3, 1, 12),
       (NULL, 'Lose Yourself', 'https://www.youtube.com/watch?v=_Yhyp-_hX2s', 'Hip-hop', 'Hardcore hip-hop', 'Solo', 341, 415609909, 5, 2, 10),
       (NULL, 'I Will Always Love You', 'https://www.youtube.com/watch?v=3JWTaaS7LdU', 'Pop', 'Pop ballad', 'Solo', 271, 895609876, 6, 1, 5),
...
LEFT JOIN composer_songs ON composer_songs.composer_id = composer.id
